    ...
    <v-card class="p-3">
      <v-row>
        <v-col cols="12" sm="12" md="4" lg="4" xl="4">
          <v-toolbar-title>Niveles académicos</v-toolbar-title>
        </v-col>
            ...
            <v-row class="pt-3">
              ...
              <v-col cols="12" sm="12" md="12">
                <base-input
                  ...
                  v-model="$v.editedItem.level_name.$model"
                  :validation="$v.editedItem.level_name"
...
<script>
import academicLevelApi from "../apis/academicLevelApi";
...
export default {
  data() {
    return {
      ...
      dialogDelete: false,
      headers: [
        { text: "NIVEL ACADÉMICO", value: "level_name" },
  ...
  methods: {
    ...
    async save() {
      ...
      if (this.editedIndex > -1) {
        ...
        const { data } = await academicLevelApi
