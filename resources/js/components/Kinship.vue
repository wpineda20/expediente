    ...
    <v-card class="p-3">
      <v-row>
        <v-col cols="12" sm="12" md="4" lg="4" xl="4">
          <v-toolbar-title>Parentescos</v-toolbar-title>
        </v-col>
          ...
          <v-container>
            ...
            <v-row class="pt-3">
              ...
              <v-col cols="12" sm="12" md="12">
                <base-input
                  label="Parentesco"
                  v-model="$v.editedItem.kinship_name.$model"
                  :validation="$v.editedItem.kinship_name"
...
<script>
import kinshipApi from "../apis/kinshipApi";
...
export default {
  data() {
    return {
      ...
      dialogDelete: false,
      headers: [
        { text: "PARENTESCO", value: "kinship_name" },
