    ...
    <v-card class="p-3">
      <v-row>
        <v-col cols="12" sm="12" md="4" lg="4" xl="4">
          <v-toolbar-title>Profesiones</v-toolbar-title>
        </v-col>
          ...
          <v-container>
            ...
            <v-row class="pt-3">
              ...
              <v-col cols="12" sm="12" md="12">
                <base-input
                  label="Profesión"
                  v-model="$v.editedItem.profession_name.$model"
                  :validation="$v.editedItem.profession_name"
  ...
  methods: {
    ...
    async save() {
      ...
      if (this.editedIndex > -1) {
        ...
        const { data } = await professionApi
