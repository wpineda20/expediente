  ...
  <div data-app>
    ...
    <v-card class="p-3">
      <v-row>
        ...
        <v-col cols="4" sm="12" md="4" lg="4" xl="4" align="end" class="pt-4">
          <v-btn
            rounded
            @click="addRecord()"
            title="Agregar"
            color="mb-2 btn-normal no-uppercase"
          >
            Agregar
          </v-btn>
          <v-icon
...
<script>
import employeeStatusApi from "../apis/employeeStatusApi";
  ...
  methods: {
    ...
    async save() {
      ...
      if (this.editedIndex > -1) {
        ...
        const { data } = await employeeStatusApi
