    ...
    <v-card class="p-3">
      <v-row>
        <v-col cols="12" sm="12" md="4" lg="4" xl="4">
          <v-toolbar-title>Estado familiar</v-toolbar-title>
        </v-col>
            ...
            <v-row class="pt-3">
              ...
              <v-col cols="12" sm="12" md="12">
                <base-input
                  ...
                  v-model="$v.editedItem.family_status_name.$model"
                  :validation="$v.editedItem.family_status_name"
...
<script>
import familyStatusApi from "../apis/familyStatusApi";
...
export default {
  data() {
    return {
      ...
      dialogDelete: false,
      headers: [
        { text: "ESTADO FAMILIAR", value: "family_status_name" },
  ...
  methods: {
    ...
    async save() {
      ...
      if (this.editedIndex > -1) {
        ...
        const { data } = await familyStatusApi
